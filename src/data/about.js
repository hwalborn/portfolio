export const aboutData = [{
  ...
  },
  {
    ...
    content: "Passion proves to be a skill that is in high demand, no matter what career you are in. I look forward to bringing my passion to a field that I’ve been intrigued in for a while. I plan on finding a team environment where communication is key. Technology is a career that constantly changes and requires adaptability from those in the field. Similar to my previous career, a person is required to be continually learning, growing from feedback, and adapting to the times. I feel confident that, though my past varies from my future, many of my skills will translate clearly."
  }
]
